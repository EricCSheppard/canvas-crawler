...
const ogre2 = new Ogre(getRandomCoordinates(game.width), getRandomCoordinates(game.width), 40, 50, 'blue')
...
// this interval runs the game loop every 30ms until we tell it to stop
